...
- **TODO**: unificar `MoviesListScreen`/`TvListScreen` (y sus detalles) en una page parametrizada por `mediaType` — se mantuvieron separadas todo el desarrollo sin que la duplicación molestara lo suficiente como para justificar el refactor. Mejora futura, no bloqueante.
